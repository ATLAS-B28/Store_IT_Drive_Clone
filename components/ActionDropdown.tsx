...
const ActionDropdown = ({file}: {file: Models.Document}) => {
  ...
  const renderDialogContent = () => {
    ...
    return (
        <DialogContent aria-describedby={undefined} className="shad-dialog button">
            <DialogHeader className="flex flex-col gap-3">
                ...
                {value === "share" && <ShareInput onInputChange={setEmails} file={file} onRemove={handleRemoveUser} />}
                {value === "delete" && (
                ...
                {/** the on change will trigger an event and we target the value from value */}
            </DialogHeader>
  ...
  return (
    <Dialog open={isModelOpen} onOpenChange={setIsOpenModel}>
